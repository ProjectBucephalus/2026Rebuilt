...
public class PBDash 
{
  ...
  public static final Key<Double>  D_INPUT_ROTATION = new Key<>("Controller Rotation", DisplayConstants.d_controlRotation);
  ...
  public static final Key<Boolean> D_FENCE_YAM      = new Key<>("Ya -", false);
  public static final Key<Boolean> D_FENCE_XBP      = new Key<>("Xb +", false);
  public static final Key<Boolean> D_FENCE_YBP      = new Key<>("Yb +", false);
  public static final Key<Boolean> D_FENCE_XBM      = new Key<>("Xb -", false);
  public static final Key<Boolean> D_FENCE_YBM      = new Key<>("Yb -", false);
